...
<div class='dashboard'>
    <div class="dashboard-nav">
        <header>
            ...
            <a class="brand-logo"><i class="fa-solid fa-trash" style="color:orange; margin: 10%;"></i> Scrap</a>
        </header>
        <nav class="dashboard-nav-list">
            <a href="home.php" class="dashboard-nav-item"><i class="fas fa-home" style="color:orange; margin: 10%;"></i> Home </a>
            <a href="dashboard.php" class="dashboard-nav-item"><i class="fas fa-tachometer-alt" style="color:orange; margin: 10%;"></i> Dashboard</a>
            <a href="#" class="dashboard-nav-item"><i class="fas fa-file-upload" style="color:orange; margin: 10%;"></i> Upload </a>
            
            <div class='dashboard-nav-dropdown'>
                <a  class="dashboard-nav-item dashboard-nav-dropdown-toggle"><i class="fa-solid fa-trash" style="color:orange; margin: 10%;"></i> Scrap </a>
                <div class='dashboard-nav-dropdown-menu'>
                    ...
                    <a href="index.php?page=analisarScrap"   class="dashboard-nav-dropdown-item">4 - Analisar Scrap</a>
                </div>
            </div>
            <div class='dashboard-nav-dropdown'>
                <a  class="dashboard-nav-item dashboard-nav-dropdown-toggle"><i class="fa-solid fa-circle-plus" style="color:orange; margin: 10%;"></i> Cadastro </a>
                <div class='dashboard-nav-dropdown-menu'>
                    ...
                    <a href="index.php?page=modelos" class="dashboard-nav-dropdown-item">Modelos</a>
                </div>
            </div>
            <a  class="dashboard-nav-item"><i class="fas fa-user" style="color:orange; margin: 10%;"></i> <?php echo htmlspecialchars($logado); ?> </a>
