                    ...
                    <div class="row">
                        ...
                        <div class='col-md-4'>
                            <div class="form-group">
                                ...
                                <input type="text" id="descricaoInput" class="form-control" placeholder="Insira a descricao">
                            ...
                            <table id="listar-partnumber" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <<th scope="col" class="text-center" id="descricao">FASE</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
...
<script>
    ...
    const partnumber = document.querySelector("#partnumberInput");
    ...
    document.getElementById('saveDataButton').addEventListener('click', function () {
        ...
        if (partnumber === "" || valor_unit === "" || descricao === "") {
