            ...
            <div class='card'>
                ...
                <div class='card-body'>
                    <div class="row">
                        ...
                        <div class='col-md-2'>
                            <div class="form-group">
                                <label for="">Selecionar Modelo</label>
                                <select id="selectModelo" placeholder="Selecione o modelo"></select>
                            </div>
                        </div>

                        <div class='col-md-2'>
                            <div class="form-group">
                                <label for="">Selecionar Cimcode</label>
                    ...
                    <div class='col-md-6'>
                            <div class="form-group">
                                ...
                                <textarea id="causaInput" class="form-control" name="story" rows="5" cols="33">
                                </textarea>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#selectCliente').on('change', function () {
            // Inicializar o Selectize Modelo
            var selectModelo = $('#selectModelo').selectize({
                maxItems: 1,
                valueField: 'id',
                labelField: 'title',
                searchField: 'title',
                ...
                load: function (query, callback) {
                    $.ajax({
                        url: 'consultas/modelos/selectModelo.php',
                        type: 'GET',
                        dataType: 'json',
                        data: {
                            q: query
                        ...
                        success: function (res) {
                            selectModelo[0].selectize.clearOptions();
                            selectModelo[0].selectize.addOption(res.options || []);
                            selectModelo[0].selectize.refreshOptions(false);
                        }
                    });
                }
            });
            ...
            var selectProduto = $('#selectProduto').selectize({
                ...
                load: function (query, callback) {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            selectProduto[0].selectize.clearOptions(); // Limpa opções antigas
    ...
    document.getElementById('saveDataButton').addEventListener('click', function () {
        ...
        const causa = document.getElementById('causaInput').value.trim();

        // Remove a obrigatoriedade do campo 'produto'
        if (modelo === "" || reincidente === "" || turno === "" || area === "" || causa === "") {
            alertify.error('Por favor, preencha todos os campos obrigatórios antes de inserir!');
        } else {
            fetch('consultas/scrap/insert.php', {
                ...
                body: new URLSearchParams({
                    'produto_id': produto, // Envia mesmo que esteja vazio
                    'modelo_id': modelo,
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('causaInput').value = '';
                    // Atualiza as tabelas
                    updateTables();
                } else {
