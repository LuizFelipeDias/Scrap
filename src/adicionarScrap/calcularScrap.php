...
<script>
    ...
    $(document).ready(function () {
        ...
        var table = $('#listar-scrap').DataTable({
            ...
            "destroy": true,
            "ajax": {
                "url": "consultas/scrapAnalise/table.php"
            },
            "columns": [
                {
                    "data": null,
        ...
        $('#saveDataButton').on('click', function() {
            ...
            if (idsSelecionados.length > 0) {
                ...
                $.ajax({
                    ...
                    data: {
                        ids: idsSelecionados,
                        novoStatus: 2 // Exemplo, altere conforme necessário
                    },
                    success: function(response) {
                        try {
                            ...
                            if (jsonResponse.success) {
                                ...
                                location.reload(); // ou qualquer outra ação que deseje
                            } else {
